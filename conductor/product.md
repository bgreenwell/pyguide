...
- **Advanced Diagnostics and Parity:**
  ...
  - Multiple Variable Importance metrics:
    - `feature_importances_`: Standard impurity-based reduction (scikit-learn compatible).
    - `interaction_importances_`: Interaction-aware impurity reduction, distributing credit among interaction partners.
    - `guide_importances_`: Authentic, unbiased importance scores based on summing Chi-square statistics across the tree (Loh & Zhou, 2021).
