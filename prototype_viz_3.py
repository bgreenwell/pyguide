...
class MockDecisionTree(BaseEstimator, ClassifierMixin):
...
mock_estimator = MockDecisionTree(mock_tree, 2)

print("Testing export_graphviz with BaseEstimator...")
try:
    dot_data = export_graphviz(mock_estimator)
    print("export_graphviz SUCCESS!")
    print(dot_data[:100] + "...")
